        ...
        <div className="simple-modal-dialog">
          ...
          <div className="simple-modal-body">
            <div className="container-solicitante">
              ...
              <input class="opening-user" onChange={() =>{this.setState({openingUser})}} type="text"/>
              <label>Enviar e-mail de fechamento p/</label>
              <input class="opening-user-mail" value="{this.state.osBeingClosed.solicitanteEmail}" type="text"/>
            </div>
          </div>
