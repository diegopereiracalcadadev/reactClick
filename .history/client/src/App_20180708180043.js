...
class SimpleModal extends React.Component{
  ...
  handleOnConfirmClick = () => {
    ...
    // this.sendCloseRequest(chamado.osNumber, openingUser, openingUserMail, chamado.description, solution)
    //     .then(res => {
        ...
        <div className="simple-modal-dialog">
          ...
          <div className="simple-modal-body">
            <div className="opening-user-container">
              ...
              <textarea onChange={(e) =>{this.setState({solution : e.target.value})}} class="solution"></textarea>
            </div>
          </div>
