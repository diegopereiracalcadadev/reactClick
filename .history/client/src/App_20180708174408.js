...
class SimpleModal extends React.Component{
  ...
  sendCloseRequest = async (osNumber, openingUser, openingUserMail) => {
    console.log("Enviando solicitação de fechamento para a OS: " + osNumber);
    const response = await fetch(`chamados/close?osNumber=${osNumber}&openingUser=${openingUser}&openingUserMail=${openingUserMail}`);
