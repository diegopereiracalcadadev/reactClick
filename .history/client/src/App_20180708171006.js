        ...
        <div className="simple-modal-dialog">
          ...
          <div className="simple-modal-body">
            <div className="container-solicitante">
              ...
              <input class="opening-user" onChange={(event) =>{this.setState({openingUser : event.target.value })}} type="text"/>
              <label>Enviar e-mail de fechamento p/</label>
              <input class="opening-user-mail" onChange={() =>{this.setState({openingUserMail : event.target.value})}} type="text"/>
            </div>
          </div>
