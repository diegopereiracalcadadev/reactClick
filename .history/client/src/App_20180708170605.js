        ...
        <div className="simple-modal-dialog">
          ...
          <div className="simple-modal-body">
            <div className="container-solicitante">
              ...
              <input class="solicitante-nome" value="{this.state.osBeingClosed.solicitanteNome}" type="text"/>
              <label>Enviar e-mail de fechamento p/</label>
              <input class="solicitante-email" value="{this.state.osBeingClosed.solicitanteEmail}" type="text"/>
            </div>
          </div>
